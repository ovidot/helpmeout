...
const Footer = () => {
  return (
    <div className="bg-[#120b48] flex flex-row gap-2 w-full h-[347px] items-center p-24 pl-[140px] pr-32">
      <div className="flex items-start justify-center gap-2 h-full">
        ...
        <div className="font-['Inter'] font-bold text-white self-start mt-3 mr-[245px]">
          HelpMeOut
        </div>
      </div>
      <div className="flex flex-col mr-[212px] gap-6 h-40 items-start">
        <div className="font-['Sora'] font-semibold text-white mb-px">Menu</div>
        <div id="LinkHome" className="font-['Work_Sans'] text-white">
          Home
        </div>
        <div id="LinkConverter" className="font-['Work_Sans'] text-white">
          Converter
        </div>
        <div id="LinkHowItWorks" className="font-['Work_Sans'] text-white">
          How it Works
        </div>
      </div>
      <div className="flex flex-col mr-[212px] gap-6 h-40 items-start">
        <div className="font-['Sora'] font-semibold text-white mb-px">
          About us
        </div>
        <div id="LinkAbout" className="font-['Work_Sans'] text-white">
          About
        </div>
        <div id="LinkContactUs" className="font-['Work_Sans'] text-white">
          Contact Us
        </div>
        <div id="LinkPrivacyPolicy" className="font-['Work_Sans'] text-white">
          Privacy Policy
        </div>
      </div>
      <div className="flex flex-col justify-between h-[149px] items-start">
        <div className="font-['Sora'] font-semibold text-white">
          Screen Record
        </div>
        <div className="font-['Work_Sans'] text-white">Browser Window</div>
        <div className="font-['Work_Sans'] text-white">Desktop</div>
        <div className="font-['Work_Sans'] text-white">Application</div>
      </div>
    </div>
  );
};
